package com.esqlcompiler;

import com.esqlcompiler.utility.*;
...
public class GenerateJavaCode {
	 ...
	 */
	private static final String FILE_PATH = "src//com//esqlcompiler//generated//";
	...
	public static boolean generateMfStructureJavaFile(
		...
		try {
			...
			writer.println("package com.esqlcompiler.generated;");
			writer.println();
	...
	public static boolean generateQueryProcessorJavaFile(HashMap<String, String> input,
		...
		/* select query from table defined here */
		...
		try {
			...
			writer.println("package com.esqlcompiler.generated;");			
			writer.println();
			writer.println("import com.esqlcompiler.utility.*;");
			...
			writer.println("\t\t Statement st = dbconnection.createStatement();");
